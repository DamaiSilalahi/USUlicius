...
class _AddFoodScreenState extends State<AddFoodScreen> {
  ...
  // 1. Tambahkan variabel ini untuk mengontrol kapan error boleh muncul
  ...
  void _submitForm() {
    // 2. Saat tombol Save ditekan, nyalakan validasi
    setState(() {
  ...
  void _resetForm() {
    // 3. Matikan validasi dulu agar merah-merah hilang saat teks dihapus
    setState(() {
      _autovalidateMode = AutovalidateMode.disabled; // <-- KUNCI PERBAIKAN
      _selectedImage = null;
      _isImageMissing = false;
    });
    ...
    return Scaffold(
      body: SafeArea(
        child: SingleChildScrollView(
          ...
          child: Form(
            key: _formKey,
            // 4. Pasang mode validasi dinamis di sini atau di TextFormField
